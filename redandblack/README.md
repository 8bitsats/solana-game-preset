...
dotnet anchorgen -i target/idl/redandblack.json -o target/idl/Redandblack.cs
```

(Replace redandblack with the name of your program)
...
useEffect(() => {
    ...
    const [pda] = PublicKey.findProgramAddressSync(
        ...
        publicKey.toBuffer()],
        new PublicKey(Redandblack_PROGRAM_ID)
      );
    try {
