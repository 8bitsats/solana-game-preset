...
import IDL from "../idl/redandblack.json";
import { Redandblack } from "@/idl/redandblack";
...
// Redandblack game program ID
export const PROGRAM_ID = new PublicKey(IDL.address);

export function getProgram(provider: AnchorProvider) {
  return new Program(IDL as Redandblack, provider);
}
...
export type PlayerData = IdlAccounts<Redandblack>["playerData"]
export type GameData = IdlAccounts<Redandblack>["gameData"]
